 ...
 * sucessivamente.
 *
 * No presente arquivo queremos uma interrupção para o pino PB1, sendo assim, setamos o bit PCINT1 do registrador PCMSK0, além
 * de setarmos o bit PCIE0 do registrador PCICR.
 */
