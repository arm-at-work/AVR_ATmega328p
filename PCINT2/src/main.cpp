 ...
 * sucessivamente.
 *
 * No presente arquivo queremos uma interrupção para o pino PD4, sendo assim, setamos o bit PCINT20 do registrador PCMSK2, além
 * de setarmos o bit PCIE2 do registrador PCICR.
 */
