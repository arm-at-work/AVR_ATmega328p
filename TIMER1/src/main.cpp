...
int main(void) {
	...
	timer1.TIMER1Config();
	do {
		/* Implementaremos um blink de 500ms, para isso calculamos:
		 * frequencia = (1 / 500) * 1000 = 2Hz
		 * alvo = (((F_CPU / 256) / 2Hz) -1) = 31249
		 */
		if (TCNT1 == 31249) { // lê contador do timer e compara com o valor que calculamos.
