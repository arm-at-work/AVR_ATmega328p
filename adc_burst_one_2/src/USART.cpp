...
/**
 * Method configures USART operation mode.
 */
...
/**
 * Method send data to USART TX Buffer
 */
...
/**
 * Method send string pointer to USART TX Buffer
 */
void USART::printString(char const * stringPtr) {
